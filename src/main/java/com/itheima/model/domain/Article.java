...
public class Article {
    ...
    private Category categorical1;//一级分类id（来自t_category）
    private Category categorical2;//二级分类id（来自t_category）

    public Category getCategorical1() {
        return categorical1;
    }

    public void setCategorical1(Category categorical1) {
        this.categorical1 = categorical1;
    }

    public Category getCategorical2() {
        return categorical2;
    }

    public void setCategorical2(Category categorical2) {
        this.categorical2 = categorical2;
    }
